  ...
  return (
    <div className="bg-gray-50 p-16">
      ...
      <div className="flex md:flex-row flex-col items-center justify-center gap-20 md:mt-10 mt-16 opacity-40">
        ...
        <Image src="https://www.aviato.co/soma-capital.png" alt="soma capital" className="h-[46px]"/>
        <Image src="https://www.aviato.co/nea.png" alt="jpmorgan" className="h-[37px]"/>
        <Image src="https://www.aviato.co/uber.png" alt="uber" className="h-[76px]"/>
        <Image src="https://www.aviato.co/merrill-lynch.png" alt="merrill lynch" className="h-[76px]"/>
      </div>
    </div>
  );
};
